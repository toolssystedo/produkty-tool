...
import type { ProductSettings as ProductSettingsType } from '@/lib/xlsx-processor';
...
export function ProductSettings({ settings, onChange, disabled }: ProductSettingsProps) {
  ...
  return (
    <div className="bg-muted rounded-xl p-4 mb-4">
      <h3 className="text-sm font-medium text-foreground mb-3">Nastavení výstupu</h3>
        ...
        <div className={`flex items-center justify-between p-3 rounded-lg border transition-colors ${
          ...
          {localSettings.related.enabled && (
            <div className="flex items-center gap-2">
              <label className="text-sm text-muted-foreground">Počet:</label>
              <Input
                type="number"
                min={1}
                max={10}
