...
import type { Stats } from '@/lib/xlsx-processor';
  ...
  if (error) {
    return (
      <Alert variant="destructive">
        ...
        <AlertTitle>Chyba při zpracování</AlertTitle>
    ...
    return (
      <div className="rounded-xl p-6 bg-accent border border-primary/20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-semibold text-primary">Zpracovávám soubor...</p>
      ...
      <div className="rounded-xl p-6 bg-accent border border-primary/20">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <p className="font-semibold mb-2 text-primary">Zpracování dokončeno</p>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-card rounded-lg p-3 text-center shadow-sm">
                ...
                <p className="text-xs text-muted-foreground">Hlavních kategorií</p>
              </div>
              <div className="bg-card rounded-lg p-3 text-center shadow-sm">
                <p className="text-2xl font-bold text-foreground">{stats.uniqueCategoryTexts}</p>
                <p className="text-xs text-muted-foreground">Unikátních cest</p>
              </div>
            </div>
          </div>
        </div>
